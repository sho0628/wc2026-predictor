...
window.WC_DATA = {
  ...
  teams: {
    ...
    'Argentina':              { code: 'ar', elo: 2114, fifa: 1874.81, fifaRank: 3,  form: 86, injPenalty: 12, adj: -20, star: 'Messi, L.Martínez', inj: 'Messi出場見込/Balerdi・Foyth離脱' },
    ...
    'Colombia':               { code: 'co', elo: 1982, fifa: 1693.09, fifaRank: 13, form: 73, injPenalty: 0,  adj: -75, star: 'J.Rodríguez, L.Díaz', inj: '大きな負傷なし' },
    ...
    'Ecuador':                { code: 'ec', elo: 1938, fifa: 1595,    fifaRank: 23, form: 72, injPenalty: 0,  adj: -55, star: 'Caicedo, Hincapié', inj: '大きな負傷なし' },
    'Germany':                { code: 'de', elo: 1932, fifa: 1730.37, fifaRank: 10, form: 80, injPenalty: 18, adj: 30, star: 'Wirtz, Musiala, Kimmich', inj: 'ter Stegen/Gnabry/Karl離脱(層は厚い)' },
    'Norway':                 { code: 'no', elo: 1914, fifa: 1551,    fifaRank: 31, form: 74, injPenalty: 0,  adj: 45, star: 'Haaland, Ødegaard', inj: '大きな負傷なし' },
    'Croatia':                { code: 'hr', elo: 1911, fifa: 1717.07, fifaRank: 11, form: 70, injPenalty: 0,  adj: -20, star: 'Modrić, Perišić', inj: 'Modrić回復・主力健在' },
    'Turkey':                 { code: 'tr', elo: 1911, fifa: 1599,    fifaRank: 22, form: 69, injPenalty: 0,  star: 'Güler, Çalhanoğlu', inj: 'Güler回復' },
    'Japan':                  { code: 'jp', elo: 1906, fifa: 1660.43, fifaRank: 18, form: 74, injPenalty: 18, adj: 20, star: 'Kubo, Endō, Kamada', inj: '三笘・南野 離脱' },
    ...
    'Paraguay':               { code: 'py', elo: 1833, fifa: 1504,    fifaRank: 40, form: 64, injPenalty: 8,  adj: -45, star: 'Almirón, Sanabria', inj: 'Enciso微妙' },
    'Austria':                { code: 'at', elo: 1830, fifa: 1593,    fifaRank: 24, form: 68, injPenalty: 8,  star: 'Arnautović, Sabitzer', inj: 'Baumgartner微妙' },
    'Morocco':                { code: 'ma', elo: 1827, fifa: 1755.87, fifaRank: 8,  form: 77, injPenalty: 8,  adj: 35, star: 'Hakimi, Brahim Díaz', inj: 'Hakimi回復段階(出場見込)' },
    ...
    'United States':          { code: 'us', elo: 1726, fifa: 1673.13, fifaRank: 16, form: 66, injPenalty: 15, adj: 55, star: 'Pulisic, T.Adams, McKennie', inj: 'Cardoso/Agyemang離脱・Richards微妙' },
    ...
    'Ivory Coast':            { code: 'ci', elo: 1695, fifa: 1533,    fifaRank: 34, form: 68, injPenalty: 0,  adj: 20, star: 'Amad Diallo', inj: '大きな負傷なし(直近で仏に勝利)' },
